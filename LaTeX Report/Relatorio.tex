...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{Recursos/snmp_operations.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{Recursos/v1_message.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.8\textwidth]{Recursos/v2_message.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[width=0.9\textwidth]{Recursos/v3_message.png}
